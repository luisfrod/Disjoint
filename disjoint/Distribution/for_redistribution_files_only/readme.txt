Packaging and Deploying Disjointlib
...
2. Installing the Disjointlib Package

A. Go to the directory that contains the file setup.py and the subdirectory Disjointlib. 
...
3. Using the Disjointlib Package
...
The Disjointlib package is on your Python path. To import it into a Python script or 
   session, execute:
