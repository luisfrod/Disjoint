Packaging and Deploying edgeDisjointNaiveDijkstraPkg
...
ii. Download the Macintosh version of the MATLAB Runtime for R2017a from:

    http://www.mathworks.com/products/compiler/mcr/index.html
   
iii. Run the MATLAB Runtime installer provided with MATLAB.

B. Verify that a Macintosh version of Python 2.7, 3.4, and/or 3.5 is installed.

2. Installing the edgeDisjointNaiveDijkstraPkg Package

A. Go to the directory that contains the file setup.py and the subdirectory 
   edgeDisjointNaiveDijkstraPkg. If you do not have write permissions, copy all its 
...
3. Using the edgeDisjointNaiveDijkstraPkg Package
...
The edgeDisjointNaiveDijkstraPkg package is on your Python path. To import it into a 
   Python script or session, execute:

    import edgeDisjointNaiveDijkstraPkg
